...
/* ============================================================
   RESQAPP — MODERN PROFESSIONAL BLUE DESIGN SYSTEM
   Clean • Government • Emergency Response • Responsive
   ============================================================ */
...
:root {
  ...
  --shadow-blue:
    0 8px 24px rgba(11, 79, 163, .20);

  --shadow-blue-lg:
    0 14px 32px rgba(11, 79, 163, .24);
